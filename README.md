# ConcurrentMultiWriter 

A Golang library for concurrent io operations. It has no dependencies other than
the golang standard library.

This is a drop-in replacement for io.MultiWriter(writers ...io.Writer).
